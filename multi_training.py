...
def main(_):
    ...
    with strategy.scope():
        ...
        OSI_Loss = losses.OrientationSelectivityLoss(tuning_angles, network=network, osi_cost=flags.osi_cost, 
        ...
        # osi_loss = OSI_Loss(rsnn_layer.output[0][0], tf.constant(0, dtype=tf.float32, shape=(1,1)), trim=True) 
