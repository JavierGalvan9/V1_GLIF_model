...
python parallel_training_testing.py --dtype 'float16' --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 50,0 --train_recurrent --train_noise --data_dir 'GLIF_network' --osi_loss_method 'crowd_osi' --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --learning_rate 0.001 --n_runs 1 --n_epochs 50 --steps_per_epoch 25
