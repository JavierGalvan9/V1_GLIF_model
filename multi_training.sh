...
python parallel_training_testing.py --neurons 65871 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --learning_rate 0.001 --n_runs 10 --n_epochs 20 --steps_per_epoch 20
