...
# num_replicas=1
# python parallel_training_testing.py --random_weights --seq_len 500 --gradient_checkpointing --optimizer 'exp_adam' --learning_rate 0.005 --data_dir 'GLIF_network' --n_gpus $num_replicas --batch_size 6 --dtype 'float16' --neurons 65871 --loss_core_radius 200 --plot_core_radius 200 --train_recurrent --train_noise --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 10 --steps_per_epoch 100
