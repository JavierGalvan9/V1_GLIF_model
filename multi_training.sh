...
# do run -g 1 -m 24 -t 2:30 -o Out/training_core.out -e Error/training_core.err -j drif_train "python multi_training.py --batch_size 1 --neurons 5000 --seq_len 600 --n_epochs 1"
...
do run -c 1 -m 72 -t 2:30 -o Out/scalene_gpu.out -e Error/scalene_gpu.err -j scalene "scalene --reduced-profile --outfile v1_scalene.html --html multi_training.py --batch_size 1 --neurons 5000 --seq_len 600 --n_epochs 1"
done
done
