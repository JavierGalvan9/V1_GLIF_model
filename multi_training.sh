...
num_replicas=1
python parallel_training_testing.py --n_gpus $num_replicas --batch_size 1 --dtype 'float16' --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --train_recurrent --train_noise --data_dir 'GLIF_network' --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 0.1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 20 --steps_per_epoch 50
