...
python parallel_training_testing.py --neurons 50000 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 1 --rate_cost 1000 --voltage_cost 1 --learning_rate 0.001 --n_runs 1 --n_epochs 1 --steps_per_epoch 1
