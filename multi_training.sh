...
### MAIN
num_replicas=1
# python parallel_training_testing.py --neuropixels_df 'Neuropixels_data/v1_OSI_DSI_DF.csv' --recurrent_weight_regularizer_type 'mean' --data_dir 'GLIF_network_nll_full' --seq_len 500 --gradient_checkpointing --optimizer 'exp_adam' --learning_rate 0.01 --n_gpus $num_replicas --batch_size 1 --dtype 'float16' --neurons 203816 --loss_core_radius 400 --plot_core_radius 400 --train_recurrent --train_noise --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 20 --steps_per_epoch 100
# # python parallel_training_testing.py --neuropixels_df 'Neuropixels_data/OSI_DSI_neuropixels_v4.csv' --data_dir 'GLIF_network_nll_full' --seq_len 500 --gradient_checkpointing --optimizer 'exp_adam' --learning_rate 0.01 --n_gpus $num_replicas --batch_size 1 --dtype 'float16' --neurons 203816 --loss_core_radius 400 --plot_core_radius 400 --train_recurrent --train_noise --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 20 --steps_per_epoch 100


python parallel_training_testing.py --neuropixels_df 'Neuropixels_data/v1_OSI_DSI_DF.csv' --recurrent_weight_regularizer_type 'emd' --data_dir 'GLIF_network_nll' --seq_len 500 --gradient_checkpointing --optimizer 'exp_adam' --learning_rate 0.005 --n_gpus $num_replicas --batch_size 1 --dtype 'float16' --neurons 65871 --loss_core_radius 200 --plot_core_radius 200 --train_recurrent --train_noise --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 1 --steps_per_epoch 5
...
# run -g 1 -m 80 -c 4 -t 12:30 -o Out/tf213.out -e Error/tf213.err -j tf213 "python osi_dsi_estimator.py --hard_reset --random_weights --n_trials_per_angle 10 --dtype 'float16' --neurons 65871 --seq_len 200 --loss_core_radius 200 --plot_core_radius 200 --reset_every_step --delays 0,0 --neuropixels_df 'Neuropixels_data/v1_OSI_DSI_DF.csv' --data_dir 'GLIF_network_nll' --restore_from '/home/jgalvan/Desktop/Neurocoding/V1_GLIF_model/Simulation_results/v1_65871_random_weights_True/b_py7q/Best_model' --ckpt_dir '/home/jgalvan/Desktop/Neurocoding/V1_GLIF_model/Simulation_results/v1_65871_random_weights_True/b_test' --run_session 1000 --train_noise --notrain_input --train_recurrent" 

# run -g 1 -G 'L40S' -m 80 -c 4 -t 12:30 -o Out/tf213.out -e Error/tf2123.err -j tf213 "python osi_dsi_estimator.py --track_core_only --hard_reset --random_weights --n_trials_per_angle 10 --dtype 'float16' --neurons 203816 --seq_len 200 --loss_core_radius 400 --plot_core_radius 400 --reset_every_step --delays 0,0 --neuropixels_df 'Neuropixels_data/v1_OSI_DSI_DF.csv' --data_dir 'GLIF_network_nll_full' --restore_from '/home/jgalvan/Desktop/Neurocoding/V1_GLIF_model/Simulation_results/v1_203816/b_fjb6/Best_model' --ckpt_dir '/home/jgalvan/Desktop/Neurocoding/V1_GLIF_model/Simulation_results/v1_203816/b_fjb6' --run_session 1000 --train_noise --notrain_input --train_recurrent" 
# run -g 1 -G 'L40S' -m 80 -c 4 -t 12:30 -o Out/tf213.out -e Error/tf2123.err -j tf213 "python osi_dsi_estimator.py --track_core_only --hard_reset --random_weights --n_trials_per_angle 10 --dtype 'float16' --neurons 65871 --seq_len 200 --loss_core_radius 400 --plot_core_radius 400 --reset_every_step --delays 0,0 --neuropixels_df 'Neuropixels_data/v1_OSI_DSI_DF.csv' --data_dir 'GLIF_network_nll' --restore_from '/home/jgalvan/Desktop/Neurocoding/V1_GLIF_model/Simulation_results/v1_65871_random_weights_True/b_py7q/Best_model' --run_session 1000 --train_noise --notrain_input --train_recurrent" 
...
#     python parallel_training_testing.py --batch_size $batch_size --neurons $neurons $common_params #--low_memory_gpu 
...
#     python parallel_training_testing.py --seq_len $seq_len --neurons $neurons $common_params #--low_memory_gpu
