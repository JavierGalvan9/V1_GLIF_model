...
num_replicas=1
python parallel_training_testing.py --data_dir 'GLIF_network2' --n_gpus $num_replicas --batch_size 2 --dtype 'float32' --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --train_recurrent --train_noise --data_dir 'GLIF_network' --osi_cost 20 --rate_cost 10000 --voltage_cost 1 --sync_cost 1 --recurrent_weight_regularization 1 --n_runs 1 --n_epochs 20 --steps_per_epoch 100
...
# python osi_dsi_estimator.py --n_trials_per_angle 3 --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --reset_every_step --delays 0,0 --ckpt_dir '' --restore_from 'Best_model' --run_session 1000 --notrain_noise --notrain_input --train_recurrent
