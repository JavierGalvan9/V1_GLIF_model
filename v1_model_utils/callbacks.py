...
class OsiDsiCallbacks:
    ...
    def fanos_figure(self, spikes, n_samples=100, analyze_core_only=True, data_dir='Synchronization_data'):
        ...
        axs[0].set_title(f'Max: {evoked_max_fano:.2f}, Freq: {evoked_max_fano_freq:.1f} Hz', fontsize=16)
        ...
        axs[1].set_title(f'Max: {spontaneous_max_fano:.2f}, Freq: {spontaneous_max_fano_freq:.1f} Hz', fontsize=16)
